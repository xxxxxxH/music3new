   ...
   private fun addBanner() {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            withContext(Dispatchers.Main) {
                val p2 = LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, dp2px(this@BasePage, 50f))
    ...
    inner class lovinInsterListener : MaxAdListener {
        ...
        override fun onAdHidden(ad: MaxAd?) {
            ...
            lifecycleScope.launch(Dispatchers.IO) {
                ...
                delay(3000)
                lovinInterstitialAd = App.instance!!.lovinInterstitialAd(this@BasePage)
